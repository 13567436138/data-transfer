...
public class TypeUtil {
    ...
    private static final Map<Integer, Class<?>> sqlType2JavaTypes = new HashMap<>();

    private static final Map<Class<?>, MethodEnity> javaType2MethodName = new HashMap<>();

    private static final Map<Class<?>, MethodPair> javaType2Method = new HashMap<>();
